...
document.addEventListener('DOMContentLoaded', function () { return __awaiter(_this, void 0, void 0, function () {
    var staffTableBody, response, staffs, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                staffTableBody = document.querySelector('#staffTable tbody');
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, fetch('/staff-data')];
            case 2:
                response = _a.sent();
                if (!response.ok)
            ...
            case 3:
                ...
                staffs.forEach(function (staff) {
                    ...
                    var securityLevelCell = document.createElement('td');
            ...
            case 4:
                err_1 = _a.sent();
                console.error('Failed to fetch staff data:', err_1);
                return [3 /*break*/, 5];
